...
public class PanelJug extends JPanel {
    ...
    public PanelJug(Controlador mainController, Jugador player) {
        ...
        drawCardButton = new JButton("Sacar Carta");
        ...
        rollDiceButton.addActionListener((ActionEvent e) -> {
            mainController.buttonRollDiceClicked(PanelJug.this);
        });
        ...
        drawCardButton.addActionListener((ActionEvent e) -> {
            Tarjeta card = mainController.buttonDrawCardClicked();
            JOptionPane.showMessageDialog(PanelJug.this, card);
            displayInfo();
        });
