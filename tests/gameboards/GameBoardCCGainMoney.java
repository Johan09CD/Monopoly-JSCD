...
public class GameBoardCCGainMoney extends TableroDeJuego {
    public GameBoardCCGainMoney() {
        ...
        Tarjeta ccCard1 = new CartaDeDinero("Ganas $50", 50, TiposDeCartas.CC);
        Tarjeta chanceCard1 = new CartaDeDinero("Ganas $30", 30, TiposDeCartas.CHANCE);
