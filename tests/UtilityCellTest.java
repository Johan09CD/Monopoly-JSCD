...
public class UtilityCellTest extends TestCase {
    ...
    public void testPlayerAction() {
            CeldaDeUtilidad cell =
                    (CeldaDeUtilidad) mainController.getGameBoard().queryCell("Utility 1");
    ...
    public void testRent() {
        ...
        CeldaDeUtilidad utility2 =
                (CeldaDeUtilidad) mainController.getGameBoard().queryCell("Utility 2");
